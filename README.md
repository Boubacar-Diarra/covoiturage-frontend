Ce projet a été réalisé dans le cadre du module d'architecture logicielle. L'objectif était de se familiariser avec le fonctionnement des frameworks modernes tels que **Spring Boot**.
